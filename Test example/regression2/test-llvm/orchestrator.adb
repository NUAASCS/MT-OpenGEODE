...
package body orchestrator is
   ...
   type ctxt_Ty is
      ...
      variable : aliased VariableString := (Data => (72, 111, 112, others => 0), Length => 3);
      fixed : aliased FixedString := (Data => (72, 101, 108, 111, others => 0));
      seqof : aliased SeqBool;
   end record;
         ...
         while (trId /= -1) loop
            case trId is
               when 0 =>
                  ...
                  ctxt.seqof.Data(1..2 + 1) := ((((1 => true) & SeqBool_Array'(1 => false, others => <>)(1 .. 1))) & SeqBool_Array'(1 => false, others => <>)(1 .. 1));
                  ...
                  ctxt.seqof.Data(1..ctxt.seqof.Length + 1) := ((ctxt.seqof.Data(1..ctxt.seqof.Length)) & SeqBool_Array'(1 => true, others => <>)(1 .. 1));
...
-- endfor
                  ...
                  ctxt.variable.Data(1..ctxt.variable.Length + 2) := ((ctxt.variable.Data(1..ctxt.variable.Length)) & VariableString_Array'(33, 33, others => <>)(1 .. 2));
