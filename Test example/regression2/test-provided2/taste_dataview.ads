...
SUBTYPE T_Uint32 is adaasn1rtl.Asn1UInt range 0 .. 100000000;
...
ERR_TC_TYPE_APID:CONSTANT INTEGER := 8; 
ERR_TC_TYPE_CONTENT:CONSTANT INTEGER := 29; 
ERR_TC_TYPE_CONTENT_CHANGE_MODE:CONSTANT INTEGER := 15; 
ERR_TC_TYPE_CONTENT_PATCH_MEMORY:CONSTANT INTEGER := 22; 
...
ERR_TM_TYPE_APID:CONSTANT INTEGER := 42; 
...
ERR_BOOLEAN_TYPE:CONSTANT INTEGER := 55; -- 
