...
package body og_type is
   ...
   procedure runTransition(Id: Integer) is
      ...
      tmp79 : BOOLEAN := False;
      tmp89 : BOOLEAN := False;
      tmp157 : aliased My_OctStr;
      --  !! stack: _call_external_function line 1271
      tmp100 : aliased My_OctStr;
      tmp108 : aliased My_OctStr;
      begin
         while (trId /= -1) loop
            case trId is
               when 0 =>
               ...
               when 1 =>
                  ...
                  tmp100 := ctxt.msg;
                  --  ANSWER 'egg' (107,17)
                  if My_OctStr_Equal(tmp100, (Data => (101, 103, 103, others => 0), Length => 3)) then
                     --  COMMENT Concatenate
                     --  strings (111,20)
                     --  msg := msg // '!!' (109,25)
                     ...
                     goto next_transition;
                     --  ANSWER 'end' (124,17)
                  elsif My_OctStr_Equal(tmp100, (Data => (101, 110, 100, others => 0), Length => 3)) then
                     --  rezult
                     --  ('Goodbye!') (126,27)
