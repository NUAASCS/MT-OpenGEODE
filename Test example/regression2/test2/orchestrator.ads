...
package orchestrator is
   ...
   procedure start_simulation(gnc_input: access T_GNC_LV_SIM_CONTEXT);
   pragma Export(C, start_simulation, "orchestrator_PI_start_simulation");
   --  Required interface "plot"
   procedure RIÜplot(gnc_data: access T_Plot);
   ...
   procedure RIÜScheduler(intr: access T_INTR);
   ...
   procedure RIÜS_SET_GNC_LV_SIM_CONTEXT_FOR_NEXT_MAJOR_CYCLE(gnc_lv_sim_context: access T_GNC_LV_SIM_CONTEXT);
   ...
   procedure RIÜS_GET_GNC_LV_SIM_INPUTS_FOR_NEXT_MAJOR_CYCLE(gnc_lv_sim_inputs: access T_GNC_LV_SIM_INPUTS);
   ...
   procedure RIÜVESAT_Simulation_Step(gnc_output: access T_GNC_LV_SIM_INPUTS; gnc_input: access T_GNC_LV_SIM_CONTEXT);
