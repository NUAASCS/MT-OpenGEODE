...
package body trafficlight is
   ...
   type ctxt_Ty is
      ...
      onÜpedwaitingÜcounter : aliased T_UInt8 := 0;
      init_state : aliased Light;
      onÜpedwaitingÜcolor : aliased Light;
      request : aliased T_Boolean;
   end record;
   ...
   procedure pedestrianRequest(buttonpress: access T_Boolean) is
      begin
         case ctxt.state is
   ...
   procedure onOff(color: access Light) is
      begin
         case ctxt.state is
            when onÜstreetattention =>
   ...
   procedure runTransition(Id: Integer) is
      trId : Integer := Id;
      tmp54 : aliased T_UInt32;
      tmp22 : Light;
      tmp36 : aliased T_UInt32;
      tmp65 : aliased Light;
      tmp57 : aliased Light;
      tmp39 : aliased Light;
      --  !! stack: _call_external_function line 1271
      tmp45 : aliased Light;
      tmp86 : aliased Light;
      tmp42 : aliased T_UInt32;
      tmp48 : aliased T_UInt32;
      tmp33 : aliased Light;
      tmp51 : aliased Light;
      tmp84 : aliased Light;
      tmp62 : aliased T_UInt32;
      begin
         while (trId /= -1) loop
            case trId is
               when 0 =>
