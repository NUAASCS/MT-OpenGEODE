...
function NegativeInt_Equal(val1, val2: in NegativeInt)
    return Boolean 
is
begin
	return val1 = val2;

end NegativeInt_Equal;
...
begin
    val := 0;
    return val;
end NegativeInt_Init;

FUNCTION NegativeInt_IsConstraintValid(val : in NegativeInt) return adaasn1rtl.ASN1_RESULT
IS
    ret : adaasn1rtl.ASN1_RESULT;
BEGIN
    ret := adaasn1rtl.ASN1_RESULT'(Success => ((-10 <= val) AND (val <= 10)), ErrorCode => ERR_NEGATIVEINT);
    RETURN ret;
END NegativeInt_IsConstraintValid;
