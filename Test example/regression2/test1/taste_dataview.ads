...
SUBTYPE NegativeInt is adaasn1rtl.Asn1Int range -10 .. 10;


function NegativeInt_Equal(val1, val2: in NegativeInt) return Boolean;

function NegativeInt_Init return NegativeInt;

ERR_NEGATIVEINT:CONSTANT INTEGER := 50; -- 
FUNCTION NegativeInt_IsConstraintValid(val : in NegativeInt) return adaasn1rtl.ASN1_RESULT;
...
ERR_MYINTEGER:CONSTANT INTEGER := 68; -- 
...
ERR_SOME_THING:CONSTANT INTEGER := 57; -- 
...
ERR_SEQOF_ELM:CONSTANT INTEGER := 82; 
ERR_SEQOF:CONSTANT INTEGER := 93; 
...
ERR_MY_OCTSTR:CONSTANT INTEGER := 75; -- 
...
ERR_TYPE1:CONSTANT INTEGER := 100; -- 
...
ERR_TYPE2:CONSTANT INTEGER := 107; -- 
...
ERR_TOTO_ELEM_1:CONSTANT INTEGER := 114; 
ERR_TOTO_ELEM_2:CONSTANT INTEGER := 125; 
...
ERR_SEQBOOL_ELM:CONSTANT INTEGER := 142; 
ERR_SEQBOOL:CONSTANT INTEGER := 149; 
...
default_str : CONSTANT TASTE_Dataview.My_OctStr:= My_OctStr'(Length => 4,Data => My_OctStr_array'(1=>16#DE#, 2=>16#AD#, 3=>16#BE#, 
                                                4=>16#EF#, others=> 16#0#)) ;
test_string : CONSTANT TASTE_Dataview.My_OctStr:= My_OctStr'(Length => 5,Data => My_OctStr_array'(1=>16#68#, 2=>16#65#, 3=>16#6C#, 
                                                4=>16#6C#, 5=>16#6F#, others=> 16#0#)) ; 
