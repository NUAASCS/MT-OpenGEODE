...
package fce is
   ...
   procedure Upload_Data(whatever: access Bool_ty);
   ...
   procedure RIÜget_fce_sgm_eeprom(fce_sgm_eeprom: access FCE_SGM_EEPROM);
   pragma import(C, RIÜget_fce_sgm_eeprom, "fce_RI_get_fce_sgm_eeprom");
   --  Sync required interface "set_fce_sgm_eeprom"
   procedure RIÜset_fce_sgm_eeprom(fce_sgm_eeprom: access FCE_SGM_EEPROM);
   pragma import(C, RIÜset_fce_sgm_eeprom, "fce_RI_set_fce_sgm_eeprom");
   --  Sync required interface "get_fce_status_register"
   procedure RIÜget_fce_status_register(fce_status_register: access FCE_RECOVERY_STATUS_REGISTER);
