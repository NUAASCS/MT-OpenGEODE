...
package orchestrator is
   ...
   procedure timeout;
   pragma Export(C, timeout, "orchestrator_PI_timeout");
   ...
   pragma import(C, SET_timeout, "orchestrator_RI_set_timeout");
   procedure RESET_timeout;
   pragma import(C, RESET_timeout, "orchestrator_RI_reset_timeout");
end orchestrator;