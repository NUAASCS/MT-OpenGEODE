...
ERR_MYINTEGER:CONSTANT INTEGER := 12; -- 
...
ERR_SOME_THING:CONSTANT INTEGER := 1; -- 
...
ERR_SEQOF_ELM:CONSTANT INTEGER := 26; 
ERR_SEQOF:CONSTANT INTEGER := 37; 
...
ERR_MY_OCTSTR:CONSTANT INTEGER := 19; -- 
