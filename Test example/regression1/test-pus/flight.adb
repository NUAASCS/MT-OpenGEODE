...
package body flight is
   ...
   type ctxt_Ty is
      ...
      myapid : aliased asn1SccAPID := asn1Sccflight;
      mytc : aliased asn1SccTelecommand;
   end record;
   ctxt: aliased ctxt_Ty;
   CS_Only  : constant Integer := 2;
   procedure runTransition(Id: Integer);
   procedure telecommand(tcdata: access asn1SccTelecommand) is
      begin
         case ctxt.state is
            when wait =>
