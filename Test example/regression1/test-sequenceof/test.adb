...
package body test is
   ...
   type ctxt_Ty is
      ...
      s3 : aliased asn1SccMySeqOf3;
      s2 : aliased asn1SccMySeqOf2;
   ...
   procedure seqof2(seqof2_param: access asn1SccMySeqOf2) is
      begin
         case ctxt.state is
            when wait =>
   ...
   procedure seqof3(seqof3_param: access asn1SccMySeqOf3) is
      begin
         case ctxt.state is
            when wait =>
