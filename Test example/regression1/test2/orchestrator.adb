...
package body orchestrator is
   ...
   type ctxt_Ty is
      ...
      plot_data : aliased asn1SccT_Plot;
      sub_cycle : aliased asn1SccT_UInt32;
      seq : aliased asn1SccTASTE_Peek_id_list := (Data => (1 => 1, others => 1), Length => 1);
      gnc_input : aliased asn1SccT_GNC_LV_SIM_CONTEXT;
      major_cycle : aliased asn1SccT_UInt32;
      intr : aliased asn1SccT_INTR;
   ...
   procedure start_simulation(gnc_input: access asn1SccT_GNC_LV_SIM_CONTEXT) is
      begin
         case ctxt.state is
            when running =>
