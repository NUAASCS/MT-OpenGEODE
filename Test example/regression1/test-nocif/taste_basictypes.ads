...
ERR_MYENUM:CONSTANT INTEGER := 93; -- 
...
ERR_MYCHOICE:CONSTANT INTEGER := 114; 
ERR_MYCHOICE_C1:CONSTANT INTEGER := 100; 
ERR_MYCHOICE_CDE2:CONSTANT INTEGER := 107; 
...
ERR_SEQOPT_A:CONSTANT INTEGER := 121; 
ERR_SEQOPT_B:CONSTANT INTEGER := 128; 
ERR_SEQOPT_C_A:CONSTANT INTEGER := 135; 
ERR_SEQOPT_D:CONSTANT INTEGER := 148; 
...
ERR_SEQNONOPT_A:CONSTANT INTEGER := 161; 
