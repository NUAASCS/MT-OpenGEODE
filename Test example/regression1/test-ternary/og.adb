...
package body og is
   ...
   type ctxt_Ty is
      ...
      msg : aliased asn1SccMyStr := (Data => (104, 101, 108, 108, 111, others => 0), Length => 5);
   ...
   procedure runTransition(Id: Integer) is
      ...
      tmp73 : aliased asn1SccMyStr;
      tmp31 : asn1SccSeqOf;
      tmp19 : asn1SccSeqOf;
      --  !! stack: _call_external_function line 1271
      tmp56 : asn1SccMyStr;
      tmp69 : aliased asn1SccMyStr;
      begin
         while (trId /= -1) loop
            case trId is
               when 0 =>
               ...
               when 2 =>
                  ...
                  if (ctxt.save_buffer.Length > 1) then
                     ...
                     tmp19.Data(1..ctxt.save_buffer.Length + 1) := ((ctxt.save_buffer.Data(1..ctxt.save_buffer.Length)) & asn1SccSeqOf_Array'(1 => false, others => <>)(1 .. 1));
               ...
               when 3 =>
                  --  msg := msg // ' world' (65,25)
                  ctxt.msg.Data(1..ctxt.msg.Length + 6) := ((ctxt.msg.Data(1..ctxt.msg.Length)) & asn1SccMyStr_Array'(32, 119, 111, 114, 108, 100, others => <>)(1 .. 6));
                  ...
                  if false then
                     ...
                     tmp56.Data(1..ctxt.msg.Length + 5 + 2) := ((((ctxt.msg.Data(1..ctxt.msg.Length)) & asn1SccMyStr_Array'(119, 111, 114, 108, 100, others => <>)(1 .. 5))) & asn1SccMyStr_Array'(33, 33, others => <>)(1 .. 2));
                  ...
                  tmp69.Data (1 .. ctxt.msg.Length + 1) := ((ctxt.msg.Data(1..ctxt.msg.Length)) & asn1SccMyStr_Array'(33, others => <>)(1 .. 1));
                  tmp69.Length := ctxt.msg.Length + 1;
                  RIÜwe(tmp69'Access);
                  --  we ('hello' // ' world!') (73,27)
                  --  !! stack: _call_external_function line 1290
                  tmp73.Data (1 .. 5 + 7) := ((104, 101, 108, 108, 111) & asn1SccMyStr_Array'(32, 119, 111, 114, 108, 100, 33, others => <>)(1 .. 7));
                  tmp73.Length := 5 + 7;
                  RIÜwe(tmp73'Access);
               ...
               when 4 =>
                  ...
                  if (ctxt.save_buffer.Length) < 10 then
                     ...
                     ctxt.save_buffer.Data(1..ctxt.save_buffer.Length + 1) := ((ctxt.save_buffer.Data(1..ctxt.save_buffer.Length)) & asn1SccSeqOf_Array'(1 => ctxt.param, others => <>)(1 .. 1));
