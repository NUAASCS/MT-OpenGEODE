...
package body og is
   ...
   type ctxt_Ty is
      ...
      ghost : aliased asn1SccMySeq;
      nestedstateÜtoto : aliased asn1SccMySeq := asn1SccMySeq'( a => false,  b => 2);
      nestedstateÜghost : aliased asn1SccMyInt := 3;
      nestedstateÜtutu : aliased asn1SccMySeq := asn1SccMySeq'( a => true,  b => 8);
      toto : aliased asn1SccMySeq;
      titi : aliased asn1SccMySeq;
   end record;
   ctxt: aliased ctxt_Ty;
   CS_Only  : constant Integer := 4;
   nestedstateÜSTART : constant := 3;
   procedure runTransition(Id: Integer);
   procedure pÜnestedstateÜabc(toto: in asn1SccMySeq;tutu: in out asn1SccMyInt);
   procedure pÜnestedstateÜabc(toto: in asn1SccMySeq;tutu: in out asn1SccMyInt) is
      ghost : aliased asn1SccMyBool := false;
      begin
         --  tutu := toto.b (44,33)
         tutu := toto.b;
         --  ghost := true (46,33)
         ...
         while (trId /= -1) loop
            case trId is
               ...
               when 2 =>
                  ...
                  ctxt.toto := asn1SccMySeq'( a => true,  b => 1);
               ...
               when 3 =>
                  ...
                  Put(asn1SccMyBool'Image(ctxt.nestedstateÜtoto.a));
                  Put(asn1SccMyInt'Image(ctxt.nestedstateÜtoto.b));
                  ...
                  ctxt.nestedstateÜtoto := asn1SccMySeq'( a => false,  b => 4);
                  --  tutu.a := TRUE (65,29)
                  ...
                  ctxt.titi := asn1SccMySeq'( a => true,  b => 42);
                  --  titi.a := FALSE (73,0)
                  ctxt.titi.a := false;
                  --  titi.b := 41 (74,0)
                  ctxt.titi.b := 41;
