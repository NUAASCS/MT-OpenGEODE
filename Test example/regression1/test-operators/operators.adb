...
package body operators is
   ...
   type ctxt_Ty is
      ...
      c : aliased asn1SccChoice := (Kind => i_PRESENT, i => 2);
      b : aliased asn1SccBoolean := true;
      e : aliased asn1SccEnum_T := asn1Sccone;
      f : aliased asn1SccReal := 2.0;
      i : aliased asn1SccInteger := 2;
      s : aliased asn1SccCharString := (Data => (72, 69, 76, 76, 79, others => 0), Length => 5);
      fixseqof : aliased asn1SccFixSeqof := (Data => (1 => 1, 2 => 2, 3 => 3, others => 1));
      varseqof : aliased asn1SccVarSeqof := (Data => (1 => 1, 2 => 2, 3 => 3, others => 1), Length => 3);
   end record;
   ...
   procedure runTransition(Id: Integer) is
      trId : Integer := Id;
      tmp29 : aliased asn1SccBoolean;
      tmp108 : aliased asn1SccCharString;
      tmp71 : aliased asn1SccCharString;
      tmp62 : aliased asn1SccCharString;
      tmp124 : aliased asn1SccCharString;
      tmp55 : aliased asn1SccCharString;
      tmp114 : aliased asn1SccBoolean;
      tmp30 : aliased asn1SccCharString;
      tmp84 : aliased asn1SccBoolean;
      --  !! stack: _call_external_function line 1271
      tmp78 : aliased asn1SccCharString;
      package Math is new Ada.Numerics.Generic_Elementary_Functions(Asn1Real);
      tmp123 : aliased asn1SccBoolean;
      tmp61 : aliased asn1SccBoolean;
      tmp22 : aliased asn1SccCharString;
      tmp54 : aliased asn1SccBoolean;
      tmp77 : aliased asn1SccBoolean;
      tmp100 : aliased asn1SccCharString;
      tmp38 : aliased asn1SccBoolean;
      tmp115 : aliased asn1SccCharString;
      tmp39 : aliased asn1SccCharString;
      tmp92 : aliased asn1SccCharString;
      tmp70 : aliased asn1SccBoolean;
      function num_asn1SccEnum_T is new Ada.Unchecked_Conversion(asn1SccEnum_T, Asn1UInt);
      tmp107 : aliased asn1SccBoolean;
      tmp21 : aliased asn1SccBoolean;
      tmp91 : aliased asn1SccBoolean;
      tmp85 : aliased asn1SccCharString;
      tmp99 : aliased asn1SccBoolean;
      tmp48 : aliased asn1SccCharString;
      tmp47 : aliased asn1SccBoolean;
      begin
         while (trId /= -1) loop
            case trId is
               when 0 =>
               ...
               when 1 =>
                  ...
                  tmp38 := (asn1SccReal'Ceiling((ctxt.f + 0.5))) = (3.0);
                  ...
                  tmp70 := (asn1SccReal'Floor((ctxt.f + 0.5))) = (ctxt.f);
                  ...
                  tmp91 := (num_asn1SccEnum_T(ctxt.e) = 12);
                  ...
                  tmp123 := (asn1SccReal'Truncation((ctxt.f + 0.1))) = (ctxt.f);
                  ...
                  Put(asn1SccInteger'Image(ctxt.i));
                  Put(asn1SccReal'Image(ctxt.f));
                  Put(asn1SccBoolean'Image(ctxt.b));
