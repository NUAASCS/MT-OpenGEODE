...
package body challenge is
   ...
   type ctxt_Ty is
      ...
      count : aliased asn1SccCountTab;
      bitwise2 : aliased asn1SccSeqBit2;
      actual_count : aliased asn1SccCountTab;
      pow_value : aliased asn1SccT_UInt32 := 0;
      bitwise : aliased asn1SccSeqBit;
      nested : aliased asn1SccNested := asn1SccNested'( a => asn1SccNested_a'( b => asn1SccNested_a_b'( c => asn1SccNested_a_b_c'( p => asn1SccPoint'( y => 2,  x => 1),  l => (Data => (1 => 3, 2 => 4, others => 3))))));
      testvalue : aliased asn1SccT_Boolean := true;
      boolwise : aliased asn1SccT_Boolean;
      check : aliased asn1SccT_UInt8;
   end record;
   ctxt: aliased ctxt_Ty;
   CS_Only  : constant Integer := 2;
   procedure runTransition(Id: Integer);
   procedure pÜtest(first: in asn1SccT_UInt8;second: in out asn1SccT_Boolean);
      ...
      while (trId /= -1) loop
         case trId is
            when 0 =>
               ...
               ctxt.nested := asn1SccNested'( a => asn1SccNested_a'( b => asn1SccNested_a_b'( c => asn1SccNested_a_b_c'( p => asn1SccPoint'( y => 2,  x => 1),  l => (Data => (1 => 3, 2 => 4, others => 3))))));
               ...
               for x in 0 .. Integer (exceed_nb) - 1 loop
                  ...
                  for n in 0 .. 19 loop
                     ...
                     begin
                        ...
                        tmp89 := asn1SccT_UInt8(((n + 1) mod 255));
