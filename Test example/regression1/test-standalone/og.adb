...
package body og is
   ...
   type ctxt_Ty is
      ...
      test : aliased asn1SccSome_Thing := 4;
      hihi : aliased asn1SccType2;
      haha : aliased asn1SccSeqOf;
   end record;
   ...
   procedure pÜaProc is
      tmp : aliased asn1SccSome_Thing := 1;
      tmp9 : aliased asn1SccSome_Thing;
